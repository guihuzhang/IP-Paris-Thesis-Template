...
\newcommand{\PhDspeciality}{Météorologie, océanographie, physique de l'environnement} 										%% Spécialité de doctorat / Speciality 
\newcommand{\GradSchool}{Géosciences, climat, environnement et planètes}
\newcommand{\PhDworkingplace}{Université de Versailles-Saint-Quentin-en-Yvelines} 										%% Établissement de préparation / PhD working place : l'Université Paris-Sud, l'Université de Versailles-Saint-Quentin-en-Yvelines, l'Université d'Evry-Val-d'Essonne, l'Institut des sciences et industries du vivant et de l'environnement (AgroParisTech), CentraleSupélec,l'Ecole normale supérieure de Cachan, l'Ecole Polytechnique, l'Ecole nationale supérieure de techniques avancées, l'Ecole nationale de la statistique et de l’administration économique, HEC Paris, l'Institut d'optique théorique et appliquée, Télécom ParisTech, Télécom SudParis   
...
\newcommand{\jurynameE}{Name LASTNAME}
\newcommand{\juryadressE}{Grade, University/Lab (research unit)}
\newcommand{\juryroleE}{Directeur de thèse}

%%% Membre n°7 (Co-directeur de thèse) / Member n°6 (Thesis co-supervisor)
\newcommand{\jurynameF}{Name LASTNAME}
\newcommand{\juryadressF}{Grade, University/Lab (research unit)}
\newcommand{\juryroleF}{Co-encadrant de thèse}

%%% Membre n°8 (Invité) / Member n°7 (Thesis co-supervisor)
\newcommand{\jurynameG}{Name LASTNAME}
\newcommand{\juryadressG}{Grade, University/Lab (research unit)}
\newcommand{\juryroleG}{Co-encadrant de thèse}

%%% Membre n°9 (Invité) / Member n°8 (Guest)
\newcommand{\jurynameH}{Name LASTNAME}
\newcommand{\juryadressH}{Grade, University/Lab (research unit)}
\newcommand{\juryroleH}{Invité, Co-encadrant de thèse}
...
\begin{textblock}{1}(-0.4,0)
	...
	\includegraphics [scale=1]{media-ipp/bande}
	%\vspace{300mm}
\end{textblock}
...
\begin{textblock}{12}(3.7,2)
	...
	\begin{flushright}
		...
		\vspace{5mm}
		\vfill 
		\footnotesize Thèse préparée à l'\PhDworkingplace, sous la direction de \jurynameE ~ (\juryadressE), le co-encadrement de \jurynameF ~ (\juryadressF), \jurynameG ~ (\juryadressG) et \jurynameH ~ (\juryadressH).\\
		\vspace{5mm}
