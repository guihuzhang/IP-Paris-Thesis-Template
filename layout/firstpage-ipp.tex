...
\newcommand{\hpos}{10.7}																		%% À modifier au besoin pour aligner les logos horizontalement / If needed, modify to align logos horizontaly
...
\begin{textblock}{5}(0,0)
	...
	%\vspace{10mm}
	\includegraphics [scale=0.95]{media-ipp/bande.png}
	\vspace{300mm}
\end{textblock}
...
% K: when using a long logo, change \hpos \vpos variables to adjust the size
\begin{textblock}{1}(\hpostt,\vpostt)
\textblockcolour{white}
\includegraphics[scale=.27]{media-ipp/etab/x-logo.png}
\end{textblock}

\begin{textblock}{1}(\hpos,\vpos)
\textblockcolour{white}
\includegraphics[scale=.3]{media-ipp/etab/inria-logo.png} 
\end{textblock}
